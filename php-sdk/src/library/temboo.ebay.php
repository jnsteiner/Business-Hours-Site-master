 ...
 * @subpackage eBay
 */
class eBay_Trading_CreateBasicListing extends Temboo_Choreography
{
    /**
     * Allows you create a basic listing on eBay using scalar inputs rather than an XML request.
     *
     * @param Temboo_Session $session The session that owns this CreateBasicListing Choreo.
     * @return eBay_Trading_CreateBasicListing New instance.
     */
    public function __construct(Temboo_Session $session)
    {
        parent::__construct($session, '/Library/eBay/Trading/CreateBasicListing/');
    }

    /**
     * Executes this Choreo.
     *
     * Execution object provides access to results appropriate for this CreateBasicListing Choreo.
     *
     * @param eBay_Trading_CreateBasicListing_Inputs|array $inputs (optional) Inputs as eBay_Trading_CreateBasicListing_Inputs or associative array.
     * @param bool $async Whether to execute in asynchronous mode. Default false.
     * @param bool $store_results Whether to store results of asynchronous execution. Default true.
     * @return eBay_Trading_CreateBasicListing_Execution New execution object.
     * @throws Temboo_Exception_Authentication if session authentication fails.
     * @throws Temboo_Exception_Execution if runtime errors occur in synchronous execution or execution fails to start. NOT thrown for post-launch errors in asynchronous execution -- check status or results to determine asynchronous success.
     * @throws Temboo_Exception_Notfound if choreography does not exist.
     * @throws Temboo_Exception if execution request fails.
    ...
    public function execute($inputs = array(), $async = false, $store_results = true)
    {
        return new eBay_Trading_CreateBasicListing_Execution($this->session, $this, $inputs, $async, $store_results);
    }

    /**
     * Obtains a new inputs object.
     *
     * Includes setters appropriate for this CreateBasicListing Choreo.
     *
     * @param array $inputs (optional) Associative array of input names and values.
     * @return eBay_Trading_CreateBasicListing_Inputs New inputs object.
     * @throws Temboo_Exception if provided input set is invalid. (Note an empty set is considered valid.)
     */
    public function newInputs($inputs = array())
    {
        return new eBay_Trading_CreateBasicListing_Inputs($inputs);
    }
}


/**
 * Inputs object with appropriate setters for the CreateBasicListing Choreo.
 *
 * @package Temboo
 * @subpackage eBay
 */
class eBay_Trading_CreateBasicListing_Inputs extends Temboo_Inputs
{
   /**
     * Inputs object with appropriate setters for the CreateBasicListing Choreo.
     *
     * @param array $inputs (optional) Associative array of input names and values.
     * @return eBay_Trading_CreateBasicListing_Inputs New instance.
     * @throws Temboo_Exception if provided input set is invalid. (Note an empty set is considered valid.)
     */
    public function __construct($inputs = array())
    {
    ...
    /**
     * Set arbitrary input this CreateBasicListing input set.
     *
     * Input names are case sensitive.
     *
     * @param string $name Input name.
     * @param string $value Input value.
     * @return eBay_Trading_CreateBasicListing_Inputs For method chaining.
     */
    public function set($name, $value)
    {
        return parent::set($name, $value);
    ...
    /**
     * Set the value for the BuyItNowPrice input for this CreateBasicListing Choreo.
     *
     * @param float $value (optional, decimal) Allows a user to purchase the item at a Buy It Now price and end the auction immediately.
     * @return eBay_Trading_CreateBasicListing_Inputs For method chaining.
     */
    ...
    /**
     * Set the value for the CategoryID input for this CreateBasicListing Choreo.
     *
     * @param int $value (conditional, integer) The numeric ID for a category on eBay. Category IDs can be retrieved with the GetCategories Choreo.
     * @return eBay_Trading_CreateBasicListing_Inputs For method chaining.
     */
    ...
    /**
     * Set the value for the ConditionID input for this CreateBasicListing Choreo.
     *
     * @param int $value (conditional, integer) The numeric ID (e.g., 1000) for the item condition.
     * @return eBay_Trading_CreateBasicListing_Inputs For method chaining.
     */
    ...
    /**
     * Set the value for the Country input for this CreateBasicListing Choreo.
     *
     * @param string $value (conditional, string) The country where the item is located in.
     * @return eBay_Trading_CreateBasicListing_Inputs For method chaining.
     */
    ...
    /**
     * Set the value for the Currency input for this CreateBasicListing Choreo.
     *
     * @param string $value (conditional, string) The currency associated with the item price.
     * @return eBay_Trading_CreateBasicListing_Inputs For method chaining.
     */
    ...
    /**
     * Set the value for the DispatchTimeMax input for this CreateBasicListing Choreo.
     *
     * @param int $value (conditional, integer) Specifies the maximum number of business days the seller commits to for preparing an item to be shipped after receiving a cleared payment.
     * @return eBay_Trading_CreateBasicListing_Inputs For method chaining.
     */
    ...
    /**
     * Set the value for the ExpeditedService input for this CreateBasicListing Choreo.
     *
     * @param bool $value (optional, boolean) Whether or not the seller is offering expedited shipping service options.
     * @return eBay_Trading_CreateBasicListing_Inputs For method chaining.
     */
    ...
    /**
     * Set the value for the ItemDescription input for this CreateBasicListing Choreo.
     *
     * @param string $value (conditional, string) The seller's description of the item.
     * @return eBay_Trading_CreateBasicListing_Inputs For method chaining.
     */
    ...
    /**
     * Set the value for the ListingDuration input for this CreateBasicListing Choreo.
     *
     * @param string $value (conditional, string) The number of days the seller wants the listing to be active (e.g., Days_7). A complete list of accepted values is returned when calling GetCategoryFeatures with DetailLevel set to ReturnAll.
     * @return eBay_Trading_CreateBasicListing_Inputs For method chaining.
     */
    ...
    /**
     * Set the value for the ListingType input for this CreateBasicListing Choreo.
     *
     * @param string $value (optional, string) The format of the listing the seller wants to use. Valid values are: AdType, Chinese, FixedPriceItem, Half, LeadGeneration.
     * @return eBay_Trading_CreateBasicListing_Inputs For method chaining.
     */
    ...
    /**
     * Set the value for the PayPalEmailAddress input for this CreateBasicListing Choreo.
     *
     * @param string $value (conditional, string) The seller's PayPal email address. Required when a PaymentMethod is PayPal.
     * @return eBay_Trading_CreateBasicListing_Inputs For method chaining.
     */
    ...
    /**
     * Set the value for the PaymentMethods input for this CreateBasicListing Choreo.
     *
     * @param string $value (conditional, string) Identifies the payment method (such as PayPal) that the seller will accept when the buyer pays for the item. This can be a comma-separated list (e.g., VisaMC,PayPal).
     * @return eBay_Trading_CreateBasicListing_Inputs For method chaining.
     */
    ...
    /**
     * Set the value for the PictureURL input for this CreateBasicListing Choreo.
     *
     * @param string $value (conditional, string) The URL for a picture associated with an item.
     * @return eBay_Trading_CreateBasicListing_Inputs For method chaining.
     */
    ...
    /**
     * Set the value for the PostalCode input for this CreateBasicListing Choreo.
     *
     * @param string $value (conditional, string) The Postal code of the place where the item is located.
     * @return eBay_Trading_CreateBasicListing_Inputs For method chaining.
     */
    ...
    /**
     * Set the value for the Quantity input for this CreateBasicListing Choreo.
     *
     * @param int $value (conditional, integer) Indicates the quantity of items available for purchase in the listing. Required for all auction listings and for non-variation, fixed-price listings. For auction listings, this value is always '1'.
     * @return eBay_Trading_CreateBasicListing_Inputs For method chaining.
     */
    ...
    /**
     * Set the value for the RefundOption input for this CreateBasicListing Choreo.
     *
     * @param string $value (optional, string) Indicates how the seller will compensate the buyer for a returned item (e.g. MoneyBack).
     * @return eBay_Trading_CreateBasicListing_Inputs For method chaining.
     */
    ...
    /**
     * Set the value for the ReservePrice input for this CreateBasicListing Choreo.
     *
     * @param float $value (optional, decimal) The lowest price at which the seller is willing to sell the item.
     * @return eBay_Trading_CreateBasicListing_Inputs For method chaining.
     */
    ...
    /**
     * Set the value for the ResponseFormat input for this CreateBasicListing Choreo.
     *
     * @param string $value (optional, string) The format that the response should be in. Valid values are: json (the default) and xml.
     * @return eBay_Trading_CreateBasicListing_Inputs For method chaining.
     */
    ...
    /**
     * Set the value for the ReturnPolicyDescription input for this CreateBasicListing Choreo.
     *
     * @param string $value (optional, string) The text description of return policy details.
     * @return eBay_Trading_CreateBasicListing_Inputs For method chaining.
     */
    ...
    /**
     * Set the value for the ReturnsAcceptedOption input for this CreateBasicListing Choreo.
     *
     * @param string $value (conditional, string) Indicates whether the seller allows the buyer to return the item (e.g., ReturnsAccepted).
     * @return eBay_Trading_CreateBasicListing_Inputs For method chaining.
     */
    ...
    /**
     * Set the value for the ReturnsWithinOption input for this CreateBasicListing Choreo.
     *
     * @param string $value (optional, string) The period of time the buyer has to return the item (e.g., Days_14). To accepted values for this field, call GeteBayDetails with DetailName set to ReturnPolicyDetails.
     * @return eBay_Trading_CreateBasicListing_Inputs For method chaining.
     */
    ...
    /**
     * Set the value for the SandboxMode input for this CreateBasicListing Choreo.
     *
     * @param bool $value (optional, boolean) Indicates that the request should be made to the sandbox endpoint instead of the production endpoint. Set to 1 to enable sandbox mode.
     * @return eBay_Trading_CreateBasicListing_Inputs For method chaining.
     */
    ...
    /**
     * Set the value for the ShippingServiceAdditionalCost input for this CreateBasicListing Choreo.
     *
     * @param float $value (optional, decimal) Shipping costs in addition to the value specified for the ShippingServiceCost parameter.
     * @return eBay_Trading_CreateBasicListing_Inputs For method chaining.
     */
    ...
    /**
     * Set the value for the ShippingServiceCost input for this CreateBasicListing Choreo.
     *
     * @param float $value (conditional, decimal) The cost for shipping the item.
     * @return eBay_Trading_CreateBasicListing_Inputs For method chaining.
     */
    ...
    /**
     * Set the value for the ShippingService input for this CreateBasicListing Choreo.
     *
     * @param string $value (conditional, string) The name of the shipping service offered (e.g. UPSGround, USPSMedia).
     * @return eBay_Trading_CreateBasicListing_Inputs For method chaining.
     */
    ...
    /**
     * Set the value for the ShippingType input for this CreateBasicListing Choreo.
     *
     * @param string $value (conditional, string) The shipping cost model offered by the seller. Valid values are: Calculated, CalculatedDomesticFlatInternational, Flat, FlatDomesticCalculatedInternational, FreightFlat, NotSpecified.
     * @return eBay_Trading_CreateBasicListing_Inputs For method chaining.
     */
    ...
    /**
     * Set the value for the SiteID input for this CreateBasicListing Choreo.
     *
     * @param string $value (optional, string) The eBay site ID that you want to access. Defaults to 0 indicating the US site.
     * @return eBay_Trading_CreateBasicListing_Inputs For method chaining.
     */
    ...
    /**
     * Set the value for the Site input for this CreateBasicListing Choreo.
     *
     * @param string $value (optional, string) The name of the site on which the item is listed. This should corresponse to the SiteID. Default value is "US".
     * @return eBay_Trading_CreateBasicListing_Inputs For method chaining.
     */
    ...
    /**
     * Set the value for the StartPrice input for this CreateBasicListing Choreo.
     *
     * @param float $value (conditional, decimal) This value indicates the starting price of the item when it is listed for the first time.
     * @return eBay_Trading_CreateBasicListing_Inputs For method chaining.
     */
    ...
    /**
     * Set the value for the Title input for this CreateBasicListing Choreo.
     *
     * @param string $value (conditional, string) The title of the item as it appears in the listing or search results.
     * @return eBay_Trading_CreateBasicListing_Inputs For method chaining.
     */
    ...
    /**
     * Set the value for the UserToken input for this CreateBasicListing Choreo.
     *
     * @param string $value (required, string) A valid eBay Auth Token.
     * @return eBay_Trading_CreateBasicListing_Inputs For method chaining.
     */
...
/**
 * Execution object for the CreateBasicListing Choreo.
 *
 * @package Temboo
 * @subpackage eBay
 */
class eBay_Trading_CreateBasicListing_Execution extends Temboo_Choreography_Execution
{
    /**
     * Execution object for the CreateBasicListing Choreo.
     *
     * @param Temboo_Session $session The session that owns this CreateBasicListing execution.
     * @param eBay_Trading_CreateBasicListing $choreo The choreography object for this execution.
     * @param eBay_Trading_CreateBasicListing_Inputs|array $inputs (optional) Inputs as eBay_Trading_CreateBasicListing_Inputs or associative array.
     * @param bool $async Whether to execute in asynchronous mode. Default false.
     * @param bool $store_results Whether to store results of asynchronous execution. Default true.
     * @return eBay_Trading_CreateBasicListing_Execution New execution.
     * @throws Temboo_Exception_Authentication if session authentication fails.
     * @throws Temboo_Exception_Execution if runtime errors occur in synchronous execution or execution fails to start. NOT thrown for post-launch errors in asynchronous execution -- check status or results to determine asynchronous success.
     * @throws Temboo_Exception_Notfound if choreography does not exist.
     */
    public function __construct(Temboo_Session $session, eBay_Trading_CreateBasicListing $choreo, $inputs = array(), $async = false, $store_results = true)
    {
        parent::__construct($session, $choreo, $inputs, $async, $store_results);
    }
     ...
     * Obtains a new results object.
     *
     * Includes getters appropriate for this CreateBasicListing execution.
     *
     * @return eBay_Trading_CreateBasicListing_Results New results object.
     * @throws Temboo_Exception_Authentication if session authentication fails.
     * @throws Temboo_Exception_Execution if runtime errors occurred in asynchronous execution.
     * @throws Temboo_Exception_Notfound if execution does not exist.
     * @throws Temboo_Exception if result request fails.
    ...
    /**
     * Wraps results in appropriate results class for this CreateBasicListing execution.
     *
     * @param array $outputs Associative array of output names and values.
     * @return eBay_Trading_CreateBasicListing_Results New results object.
     */
    protected function wrapResults($outputs)
    {
        return new eBay_Trading_CreateBasicListing_Results($outputs);
    }
}


/**
 * Results object with appropriate getters for the CreateBasicListing Choreo.
 *
 * @package Temboo
 * @subpackage eBay
 */
class eBay_Trading_CreateBasicListing_Results extends Temboo_Results
{
    /**
     * Results object with appropriate getters for the CreateBasicListing Choreo.
     *
     * @param array $outputs (optional) Associative array of output names and values.
     * @return eBay_Trading_CreateBasicListing_Results New instance.
     * @throws Temboo_Exception if provided output set is invalid. (Note an empty set is considered valid.)
     */
    public function __construct($outputs = array())
    {
    ...
    /**
     * Retrieve the value for the "Response" output from this CreateBasicListing execution.
     *
     * @return string The response from eBay.
     * @throws Temboo_Exception_Notfound if output does not exist. (Note an empty response is considered valid.)
     */
