 ...
 * @subpackage MongoHQ
 */
class MongoHQ_Plans_ListPlans extends Temboo_Choreography
{
    /**
     * Returns a list of the shared plans and custom deploys.
     *
     * @param Temboo_Session $session The session that owns this ListPlans Choreo.
     * @return MongoHQ_Plans_ListPlans New instance.
     */
    public function __construct(Temboo_Session $session)
    {
        parent::__construct($session, '/Library/MongoHQ/Plans/ListPlans/');
    }

    /**
     * Executes this Choreo.
     *
     * Execution object provides access to results appropriate for this ListPlans Choreo.
     *
     * @param MongoHQ_Plans_ListPlans_Inputs|array $inputs (optional) Inputs as MongoHQ_Plans_ListPlans_Inputs or associative array.
     * @param bool $async Whether to execute in asynchronous mode. Default false.
     * @param bool $store_results Whether to store results of asynchronous execution. Default true.
     * @return MongoHQ_Plans_ListPlans_Execution New execution object.
     * @throws Temboo_Exception_Authentication if session authentication fails.
     * @throws Temboo_Exception_Execution if runtime errors occur in synchronous execution or execution fails to start. NOT thrown for post-launch errors in asynchronous execution -- check status or results to determine asynchronous success.
     * @throws Temboo_Exception_Notfound if choreography does not exist.
     * @throws Temboo_Exception if execution request fails.
    ...
    public function execute($inputs = array(), $async = false, $store_results = true)
    {
        return new MongoHQ_Plans_ListPlans_Execution($this->session, $this, $inputs, $async, $store_results);
    }

    /**
     * Obtains a new inputs object.
     *
     * Includes setters appropriate for this ListPlans Choreo.
     *
     * @param array $inputs (optional) Associative array of input names and values.
     * @return MongoHQ_Plans_ListPlans_Inputs New inputs object.
     * @throws Temboo_Exception if provided input set is invalid. (Note an empty set is considered valid.)
     */
    public function newInputs($inputs = array())
    {
        return new MongoHQ_Plans_ListPlans_Inputs($inputs);
    }
}


/**
 * Inputs object with appropriate setters for the ListPlans Choreo.
 *
 * @package Temboo
 * @subpackage MongoHQ
 */
class MongoHQ_Plans_ListPlans_Inputs extends Temboo_Inputs
{
   /**
     * Inputs object with appropriate setters for the ListPlans Choreo.
     *
     * @param array $inputs (optional) Associative array of input names and values.
     * @return MongoHQ_Plans_ListPlans_Inputs New instance.
     * @throws Temboo_Exception if provided input set is invalid. (Note an empty set is considered valid.)
     */
    public function __construct($inputs = array())
    {
    ...
    /**
     * Set arbitrary input this ListPlans input set.
     *
     * Input names are case sensitive.
     *
     * @param string $name Input name.
     * @param string $value Input value.
     * @return MongoHQ_Plans_ListPlans_Inputs For method chaining.
     */
    public function set($name, $value)
    {
        return parent::set($name, $value);
    ...
    /**
     * Set the value for the APIToken input for this ListPlans Choreo.
     *
     * @param string $value (required, string) The API Token provided by MongoHQ.
     * @return MongoHQ_Plans_ListPlans_Inputs For method chaining.
     */
...
/**
 * Execution object for the ListPlans Choreo.
 *
 * @package Temboo
 * @subpackage MongoHQ
 */
class MongoHQ_Plans_ListPlans_Execution extends Temboo_Choreography_Execution
{
    /**
     * Execution object for the ListPlans Choreo.
     *
     * @param Temboo_Session $session The session that owns this ListPlans execution.
     * @param MongoHQ_Plans_ListPlans $choreo The choreography object for this execution.
     * @param MongoHQ_Plans_ListPlans_Inputs|array $inputs (optional) Inputs as MongoHQ_Plans_ListPlans_Inputs or associative array.
     * @param bool $async Whether to execute in asynchronous mode. Default false.
     * @param bool $store_results Whether to store results of asynchronous execution. Default true.
     * @return MongoHQ_Plans_ListPlans_Execution New execution.
     * @throws Temboo_Exception_Authentication if session authentication fails.
     * @throws Temboo_Exception_Execution if runtime errors occur in synchronous execution or execution fails to start. NOT thrown for post-launch errors in asynchronous execution -- check status or results to determine asynchronous success.
     * @throws Temboo_Exception_Notfound if choreography does not exist.
     */
    public function __construct(Temboo_Session $session, MongoHQ_Plans_ListPlans $choreo, $inputs = array(), $async = false, $store_results = true)
    {
        parent::__construct($session, $choreo, $inputs, $async, $store_results);
    }
     ...
     * Obtains a new results object.
     *
     * Includes getters appropriate for this ListPlans execution.
     *
     * @return MongoHQ_Plans_ListPlans_Results New results object.
     * @throws Temboo_Exception_Authentication if session authentication fails.
     * @throws Temboo_Exception_Execution if runtime errors occurred in asynchronous execution.
     * @throws Temboo_Exception_Notfound if execution does not exist.
     * @throws Temboo_Exception if result request fails.
    ...
    /**
     * Wraps results in appropriate results class for this ListPlans execution.
     *
     * @param array $outputs Associative array of output names and values.
     * @return MongoHQ_Plans_ListPlans_Results New results object.
     */
    protected function wrapResults($outputs)
    {
        return new MongoHQ_Plans_ListPlans_Results($outputs);
    }
}


/**
 * Results object with appropriate getters for the ListPlans Choreo.
 *
 * @package Temboo
 * @subpackage MongoHQ
 */
class MongoHQ_Plans_ListPlans_Results extends Temboo_Results
{
    /**
     * Results object with appropriate getters for the ListPlans Choreo.
     *
     * @param array $outputs (optional) Associative array of output names and values.
     * @return MongoHQ_Plans_ListPlans_Results New instance.
     * @throws Temboo_Exception if provided output set is invalid. (Note an empty set is considered valid.)
     */
    public function __construct($outputs = array())
    {
    ...
    /**
     * Retrieve the value for the "Response" output from this ListPlans execution.
     *
     * @return string (json) The response from MongoHQ.
     * @throws Temboo_Exception_Notfound if output does not exist. (Note an empty response is considered valid.)
     */
...
class MongoHQ_Databases_CreateDatabase_Inputs extends Temboo_Inputs
{
   /**
     ...
     *
     * @param string $value (required, string) The type of database to create (e.g., sandbox, small, large). A full list of database types are returned by the ListPlans Choreo and are represented in the "slug" property of each plan object.
     * @return MongoHQ_Databases_CreateDatabase_Inputs For method chaining.
     */
