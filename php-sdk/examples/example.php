 ...
 * https://live.temboo.com/library/Library/NYTimes/MovieReviews/
 */
try {
    ...
    $getReviewsByKeyword = new NYTimes_MovieReviews_GetReviewsByKeyword($session);

    // Get an input object for the Choreo
    $getReviewsByKeywordInputs = $getReviewsByKeyword->newInputs();

    // Set inputs
    $getReviewsByKeywordInputs->setQuery("Casablanca")->setResponseFormat("json");

    // Execute Choreo and get results
    $getReviewsByKeywordResults = $getReviewsByKeyword->execute($getReviewsByKeywordInputs)->getResults();

    // Print the results
    $jsonResponse = $getReviewsByKeywordResults->getResponse();
